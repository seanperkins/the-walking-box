module.exports = function() {
  ...
  Lighting.getWallIntersection = function(game, ray, walls) {
  ...
  Lighting.update = function(game, player, objects){
    ...
    if (wall.inCamera) {
      ...
      for(i = 0; i < corners.length; i++) {
          ...
          intersect = Lighting.getWallIntersection(game, ray, objects);
          if (intersect) {
